...
axs[0].fill_between(solution.t, S_observed, S_fitted, where=(S_fitted > S_observed), facecolor='blue', alpha=0.5, interpolate=True, label='Above Difference')
axs[0].fill_between(solution.t, S_observed, S_fitted, where=(S_fitted < S_observed), facecolor='red', alpha=0.5, interpolate=True, label='Below Difference')
...
axs[1].fill_between(solution.t, I_observed, I_fitted, where=(I_fitted > I_observed), facecolor='blue', alpha=0.5, interpolate=True, label='Above Difference')
axs[1].fill_between(solution.t, I_observed, I_fitted, where=(I_fitted < I_observed), facecolor='red', alpha=0.5, interpolate=True, label='Below Difference')
...
axs[2].fill_between(solution.t, R_observed, R_fitted, where=(R_fitted > R_observed), facecolor='blue', alpha=0.5, interpolate=True, label='Above Difference')
axs[2].fill_between(solution.t, R_observed, R_fitted, where=(R_fitted < R_observed), facecolor='red', alpha=0.5, interpolate=True, label='Below Difference')
